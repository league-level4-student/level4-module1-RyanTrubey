...
public class Snake {
	...
	public void update() {
		...
		case RIGHT:
			...
			break;
		default:
			newLocation = new Location(head.getLocation().x, head.getLocation().y);
			break;
		}
	...
	public void setDirection(Direction d) {
		...
		if (canMove) {
			if (d.equals(Direction.DOWN) && !currentDirection.equals(Direction.UP)) {
				currentDirection = d;
				canMove = false;
			}
			if (d.equals(Direction.UP) && !currentDirection.equals(Direction.DOWN)) {
				currentDirection = d;
				canMove = false;
			}
			if (d.equals(Direction.LEFT) && !currentDirection.equals(Direction.RIGHT)) {
				currentDirection = d;
				canMove = false;
			}
			if (d.equals(Direction.RIGHT) && !currentDirection.equals(Direction.LEFT)) {
				currentDirection = d;
				canMove = false;
			}
		}
