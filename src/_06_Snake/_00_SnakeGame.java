...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "wasd for move don't die";
	...
	private void setFoodLocation() {
		...
		Location location = new Location(new Random().nextInt(WIDTH), new Random().nextInt(HEIGHT));
		...
		if(snake.isLocationOnSnake(location)) {
			location = new Location(new Random().nextInt(WIDTH), new Random().nextInt(HEIGHT));
	...
	private void gameOver() {
		...
		JOptionPane.showMessageDialog(null, "Youre snake is dead");
